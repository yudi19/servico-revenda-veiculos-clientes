...
class ConsultarClienteServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new ConsultarClienteService(repositoryPort, cryptoPort, auditPort);
    }

    @Test
    void deveConsultarClienteEDescriptografarDados() {
        ...
        verify(auditPort).registrar(eq(id), eq("CONSULTA"), anyString());
